const zhCN = {
  ...
  'settings.recycleRetentionDays': '回收站保留天数（1–365天）',
  ...
  'settings.keepAudibleTabsOpen': '关闭标签页时-是否保留正在播放音视频的标签页{mark}',
  'settings.keepAudibleTabsOpen.tooltip': '开启后，发送标签页时若某个标签页正在播放音频/视频，则该标签页仍会发送到NiceTab，但不会被自动关闭（已静音的标签页除外）',
  'settings.keepAudibleTabsOpen.yes': '保留正在播放音视频的标签页（推荐）',
  'settings.keepAudibleTabsOpen.no': '一并关闭',
