...
const enUS: Record<LocaleKey, string> = {
  ...
  'settings.keepAudibleTabsOpen': 'Keep tabs playing audio/video open when closing tabs?{mark}',
  'settings.keepAudibleTabsOpen.tooltip': 'When enabled, tabs that are currently playing audio/video are still sent to NiceTab, but will not be closed automatically (muted tabs are excluded).',
  'settings.keepAudibleTabsOpen.yes': 'Keep them open (recommended)',
  'settings.keepAudibleTabsOpen.no': 'Close them as well',
